/*  1971. Find if Path Exists in Graph  // Level: Easy
...
Example 1:
Image Link: https://assets.leetcode.com/uploads/2021/08/14/validpath-ex1.png
============================================================================>
...
Example 2:
Image Link: https://assets.leetcode.com/uploads/2021/08/14/validpath-ex2.png
============================================================================>
...
var validPath = function(n, edges, source, destination) {
    ...
    travel(source, visited, graph); 
    return visited[destination];  
};

function travel(n, visited, graph) {
